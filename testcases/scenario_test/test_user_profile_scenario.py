...
class TestUserProfileScenario:
    ...
    async def test_user_profile_scenario(self, case: UserProfileScenarioCase, auth_api: AuthAPI):
        ...
        with allure.step(step_1):
            ...
            assert_result(register_result, case.expected['register'])
        ...
        with allure.step(step_2):
            ...
            assert_result(login_result, case.expected['login'])
        ...
        try:
            ...
            with allure.step(step_3):
                ...
                assert_result(get_info_result, case.expected['get_initial_info'])
            ...
            with allure.step(step_4):
                ...
                assert_result(update_name_result, case.expected['update_name'])
        ...
        with allure.step(step_5):
            ...
            assert_result(change_password_result, case.expected['change_password'])
        ...
        with allure.step(step_6):
            ...
            assert_result(verify_login_result, case.expected['login'])
        ...
        with allure.step(step_7):
            ...
            assert_result(revert_password_result, case.expected['revert_password'])
